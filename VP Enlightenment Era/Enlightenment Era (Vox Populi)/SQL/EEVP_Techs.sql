...
('TXT_KEY_TECH_EE_SOVEREIGNTY_HELP', 'Allows you to build a range of buildings and wonders focused on great person generation. Also unlocks the ability to found the World Congress.'),
