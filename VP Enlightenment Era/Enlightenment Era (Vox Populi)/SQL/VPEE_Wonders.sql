...
INSERT INTO Buildings (Type, BuildingClass, PrereqTech, MaxStartEra, SpecialistType, GreatPeopleRateChange, PortraitIndex, WonderSplashImage, WonderSplashAudio) VALUES
('BUILDING_EE_FASIL_GHEBBI', 'BUILDINGCLASS_EE_FASIL_GHEBBI', 'TECH_EE_FORTIFICATION','ERA_INDUSTRIAL',   'SPECIALIST_ENGINEER', 1, 6,'EE_FasilGhebbi_splash.dds',  'AS2D_WONDER_SPEECH_EE_FASIL_GHEBBI'),
('BUILDING_EE_KRONBORG',     'BUILDINGCLASS_EE_KRONBORG',     'TECH_EE_WARSHIPS',     'ERA_INDUSTRIAL',   'SPECIALIST_MERCHANT', 1, 2,'EE_Kronborg_splash.dds',     'AS2D_WONDER_SPEECH_EE_KRONBORG'),
('BUILDING_EE_SMITHSONIAN',  'BUILDINGCLASS_EE_SMITHSONIAN',  'TECH_EE_ROMANTICISM',  'ERA_MODERN',       'SPECIALIST_SCIENTIST',1, 4,'EE_SMITHSONIAN_splash.dds',  'AS2D_WONDER_SPEECH_EE_SMITHSONIAN'),
('BUILDING_EE_TOPKAPI',      'BUILDINGCLASS_EE_TOPKAPI',      'TECH_EE_SOVEREIGNTY',  'ERA_ENLIGHTENMENT', NULL,                 0, 0,'EE_TOPKAPI_splash.dds',      'AS2D_WONDER_SPEECH_EE_TOPKAPI'),
('BUILDING_EE_TORRE',        'BUILDINGCLASS_EE_TORRE',        'TECH_NAVIGATION',      'ERA_INDUSTRIAL',   'SPECIALIST_MERCHANT', 1, 1,'EE_Torre_splash.dds',        'AS2D_WONDER_SPEECH_EE_TORRE'),
('BUILDING_EE_VERSAILLES',   'BUILDINGCLASS_EE_VERSAILLES',   'TECH_EE_SOVEREIGNTY',  'ERA_ENLIGHTENMENT', NULL,                 0, 7,'EE_Versailles_splash.dds',   'AS2D_WONDER_SPEECH_EE_VERSAILLES'),
('BUILDING_EE_WAT_PHRA_KAEW','BUILDINGCLASS_EE_WAT_PHRA_KAEW','TECH_EE_HUMANISM',     'ERA_INDUSTRIAL',   'SPECIALIST_SCIENTIST',1, 5,'EE_Wat_Phra_Kaew_splash.dds','AS2D_WONDER_SPEECH_EE_WAT_PHRA_KAEW');

UPDATE Buildings
SET Description = 'TXT_KEY_'||Type, Civilopedia = 'TXT_KEY_WONDER_'||SUBSTR(Type,10)||'_PEDIA', Quote = 'TXT_KEY_WONDER_'||SUBSTR(Type,10)||'_QUOTE', Help = 'TXT_KEY_WONDER_'||SUBSTR(Type,10)||'_HELP',
	NukeImmune = 1, HurryCostModifier = -5, MinAreaSize = -1, ConquestProb = 100, IconAtlas = 'ENLIGHTENMENT_WONDER_ATLAS', WonderSplashAnchor = 'L,B'
WHERE Type IN (
