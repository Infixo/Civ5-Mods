...
('PROMOTION_2HANDER',        'PEDIA_ATTRIBUTES', 'AS2D_IF_LEVELUP'),
('PROMOTION_CBOEE_SKIRMISH',        'PEDIA_ATTRIBUTES', 'AS2D_IF_LEVELUP'),
('PROMOTION_EE_FIRST_RATE',  'PEDIA_ATTRIBUTES', 'AS2D_IF_LEVELUP'),
('PROMOTION_EE_FIRST_RATE_DEFENSE','PEDIA_ATTRIBUTES', 'AS2D_IF_LEVELUP'),
('PROMOTION_EE_DRYDOCK',     'PEDIA_ATTRIBUTES', NULL),
('PROMOTION_EE_EXPLORER',    'PEDIA_ATTRIBUTES', NULL),
