...
('TXT_KEY_WONDER_EE_FASIL_GHEBBI_HELP', 'Friendly military units within 3-tile range of Fasil Ghebbi gain +25% [ICON_STRENGTH] Combat Strength. City gets additional +100 HP and +10 [ICON_STRENGTH] Defense. Increases the Military Unit Supply Cap by 5.'),
...
SET Text = 'Receive a free [ICON_GREAT_ENGINEER] Great Engineer and a free Bastion in the city. Provides +100 HP and +30 [ICON_STRENGTH] Defense to the city, and increases the Military Unit Supply Cap from population by 5% in all Cities.'
