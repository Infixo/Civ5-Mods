...
-- Infixo
UPDATE Language_en_US
SET Text = 'Extends the length of [ICON_HAPPINESS_1] We Love The King Day by 50% empire-wide. 1 free [ICON_GREAT_PEOPLE] Great Writer appears near the City where the wonder was built and immediately starts [ICON_GOLDEN_AGE] Golden Age.'
WHERE Tag = 'TXT_KEY_WONDER_EE_VERSAILLES_HELP';

-- Infixo
UPDATE Language_en_US
SET Text = '+50 HP and 5 Defense in all coastal cities, +50% production for naval units in the city where the wonder is built in. Can only be built near water. 1 free [ICON_GREAT_PEOPLE] Great Admiral appears near the City where the wonder was built.'
...
-- Infixo added
UPDATE Language_en_US
SET Text = 'City must not contain a Salon. +2 [ICON_RESEARCH] Science in the the city and +1 [ICON_RESEARCH] Science for every 5 [ICON_CITIZEN] Citizens in the City.'
...
-- Infixo added
UPDATE Language_en_US
SET Text = 'City must not contain an Academy. +2 [ICON_CULTURE] Culture in the the city and +1 [ICON_CULTURE] Culture for every 6 [ICON_CITIZEN] Citizens in the City.'
...
UPDATE Language_en_US
SET Text = 'City must contain a Bank. +3 [ICON_GOLD] Gold in the the city and +1 [ICON_GOLD] Gold for every 4 [ICON_CITIZEN] Citizens in the City.'
