...
-- Infixo: activate Crystal Palace
--UPDATE BuildingClasses SET MaxGlobalInstances = -1 WHERE Type = 'BUILDINGCLASS_EE_CRYSTAL_PALACE';
...
SET Yield = 2 
WHERE BuildingType = 'BUILDING_EE_GALLERY';
...
--INSERT INTO Building_YieldChangesPerPop	(BuildingType, YieldType, Yield)
--VALUES									('BUILDING_THEATRE', 'YIELD_CULTURE', 17); -- every 6 pop
...
-- Infixo: need more so late
UPDATE Buildings
SET Defense = 1500, ExtraCityHitPoints = 150
WHERE Type = 'BUILDING_EE_BASTION';

-- Infixo: lower other defensive buildings for balance
UPDATE Buildings
SET Defense = 1000, ExtraCityHitPoints = 100
WHERE Type = 'BUILDING_ARSENAL';

-- Infixo: lower other defensive buildings for balance
UPDATE Buildings
SET Defense = 2000, ExtraCityHitPoints = 150
...
UPDATE Building_YieldModifiers
SET Yield = '10'
WHERE BuildingType = 'BUILDING_EE_WEIGH_HOUSE';
...
UPDATE Building_YieldChanges SET Yield = 0 WHERE BuildingType = 'BUILDING_EE_KRONBORG';
...
UPDATE Buildings
SET ExtraCityHitPoints = 50, Defense = 500
WHERE Type = 'BUILDING_EE_KRONBORG_DUMMY';

UPDATE Buildings
SET ExtraCityHitPoints = 0, Defense = 0
WHERE Type = 'BUILDING_EE_KRONBORG';

UPDATE Buildings
SET GreatPeopleRateModifier = 15 -- Infixo: type is integer
