...
-- Infixo
UPDATE Language_en_US
SET Text = '+50 HP and 5 Defense in all coastal cities, +50% production for naval units in the city where the wonder is built in. Can only be built near water. 1 free Great Admiral appears near the City where the wonder was built.'
...
UPDATE Language_en_US
SET Text = 'Kronborg Dummy +50HP +5DEF'
WHERE Tag IN ('TXT_KEY_BUILDING_EE_KRONBORG_DUMMY_STRATEGY');

-- Infixo
UPDATE Language_en_US
SET Text = 'Friendly military units within 3-tile range of Fasil Ghebbi have +25% combat strength. City gets additional 100 hit points and 10 defense.'
...
UPDATE Language_en_US
SET Text = '+20% Combat Strength when in 3-tile range of Fasil Ghebbi.'
...
UPDATE Language_en_US
SET Text = 'Throughout history there are those whose thirst for adventure led them from the safe confines of civilized lands. These adventurers, frequently funded by government stipends, would then journey into the unknown, charting their progress all the way.
 These expeditions, and the maps they helped create, became blueprints for the conquest and domestication of the once uncharted regions of the world.'
...
UPDATE Language_en_US
SET Text = 'Reduces [ICON_HAPPINESS_3] Boredom. Increases Science and Culture. City must have a Zoo.'
WHERE Tag = 'TXT_KEY_BUILDING_EE_MENAGERIE_HELP';

UPDATE Language_en_US
SET Text = 'The Menagerie reduces Boredom in a city, and produces additional Science and Culture. The city must possess a Tavern before the Menagerie can be constructed. '
...
-- Infixo added
UPDATE Language_en_US
SET Text = 'City must not contain a Salon. Boosts [ICON_SCIENCE] Science output of the city by +10%.'
WHERE Tag IN ('TXT_KEY_BUILDING_EE_ACADEMY_HELP');

UPDATE Language_en_US
SET Text = 'The Academy is an Enlightenment-era building which increases the [ICON_SCIENCE] Science output of a city by 10%. It may not be built in a city with an Salon, forcing cities to specialise in either Culture or Science.'
WHERE Tag IN ('TXT_KEY_BUILDING_EE_ACADEMY_STRATEGY');

-- Infixo added
UPDATE Language_en_US
SET Text = 'City must not contain an Academy. Boosts [ICON_CULTURE] Culture output of the city by +10%.'
WHERE Tag IN ('TXT_KEY_BUILDING_EE_SALON_HELP');

UPDATE Language_en_US
SET Text = 'The Salon is an Enlightenment-era building which increases the [ICON_CULTURE] Culture output of a city by 10%. It may not be built in a city with an Academy, forcing cities to specialise in either Culture or Science.'
WHERE Tag IN ('TXT_KEY_BUILDING_EE_SALON_STRATEGY');

UPDATE Language_en_US
SET Text = 'Boosts [ICON_GOLD] Gold output of the city by 10%. City must contain a Bank.'
...
UPDATE Language_en_US
SET Text = 'Provides a free [ICON_GREAT_PEOPLE] Great Person of your choice near the [ICON_CAPITAL] Capital. Reduces [ICON_HAPPINESS_3] Religious Unrest in all cities.[NEWLINE][NEWLINE]Must have built a Manor in the city. The [ICON_PRODUCTION] Production Cost and [ICON_CITIZEN] Population Requirements increase based on the number of cities you own.'
WHERE Tag IN ('TXT_KEY_BUILDING_EE_SUMMER_PALACE_HELP');

UPDATE Language_en_US
SET Text = 'This National Wonder provides a free [ICON_GREAT_PEOPLE] Great Person of your choice in the [ICON_CAPITAL] Capital. It also provides +1 [ICON_CULTURE] Culture. A city must have a Manor before it can construct the The Tower of Buddhist Incense.'
...
UPDATE Language_en_US
SET Text = '+2 [ICON_RESEARCH] Science from Religious buildings. City must be built on a river.'
WHERE Tag IN ('TXT_KEY_WONDER_EE_WAT_PHRA_KAEW_HELP');

-- Infixo added
UPDATE Language_en_US
SET Text = '+1 [ICON_PEACE] Faith from Defensive buildings. Does not apply to gifted ones.'
WHERE Tag IN ('TXT_KEY_WONDER_EE_TOPKAPI_HELP');

-- Infixo added
UPDATE Language_en_US
SET Text = 'Naval trade routes originating from this city have a 50% increase in range, and provide +3 gold for both parties. Grants 1 [ICON_TRADE] additional trade route. City must be built on the coast.'
...
WHERE Tag IN ('TXT_KEY_UNIT_EE_SHIP_OF_THE_LINE_STRATEGY');
...
UPDATE Language_en_US
SET Text = 'Naval units trained in this city have +15% combat strength. City must contain a Harbor.'
WHERE Tag IN ('TXT_KEY_BUILDING_EE_DRYDOCK_HELP');

UPDATE Language_en_US
SET Text = 'The Drydock is a late Enlightenment Era building which increases the combat strength of naval units which are trained in the city. In order to build a Drydock, the city must first contain a Harbor.'
WHERE Tag IN ('TXT_KEY_BUILDING_EE_DRYDOCK_STRATEGY');

UPDATE Language_en_US
SET Text = '20% [ICON_PRODUCTION] Production when building Gunpowder Units which also receive additional 15 XP.'
WHERE Tag IN ('TXT_KEY_BUILDING_EE_GUNSMITH_HELP');

UPDATE Language_en_US
SET Text = '+1 [ICON_CULTURE] Culture for every 6 [ICON_CITIZEN] Citizens in the City. Contains one Great Work of Art slot. +10% [ICON_GREAT_ARTIST] Great Artist Rate in the City, and all Artists'' Guilds produce +1 [ICON_GOLD] Gold.'
WHERE Tag = 'TXT_KEY_BUILDING_EE_GALLERY_HELP';

UPDATE Language_en_US
SET Text = '+1 [ICON_CULTURE] Culture for every 4 [ICON_CITIZEN] Citizens in the City. Contains two Great Work of Art slots. +20% [ICON_GREAT_ARTIST] Great Artist Rate in the City. +5 [ICON_CULTURE] Culture if Themed.'
WHERE Tag = 'TXT_KEY_BUILDING_MUSEUM_HELP';

--UPDATE Language_en_US
--SET Text = '+1 [ICON_CULTURE] Culture for every 6 [ICON_CITIZEN] Citizens in the City.'
--WHERE Tag = 'TXT_KEY_BUILDING_THEATRE_HELP';

UPDATE Language_en_US
SET Text = 'Reduces [ICON_HAPPINESS_3] Boredom slightly. Market, Caravansary, Harbor and Customs House in City: + 1 [ICON_RESEARCH] Science [NEWLINE]Nearby [ICON_RES_WHEAT] Wheat: +1 [ICON_FOOD] Food'
...
-- Infixo: First Rate
UPDATE Language_en_US
SET Text = 'Powerful Enlightenment Era naval ranged unit which boosts the defensive strength of adjacent friendly units and can fire twice per turn.  Only the English may build it.'
WHERE Tag = 'TXT_KEY_UNIT_EE_ENGLISH_FIRST_RATE_HELP';

-- Infixo: First Rate
UPDATE Language_en_US
SET Text = 'The First Rate is England’s unique unit, replacing the Frigate.  However, it is much stronger than the unit it replaces because it can fire twice per turn.  It also provides combat boosts to nearby allied ships when defending.  Use it as part of a larger fleet to greatly increase your naval firepower.'
WHERE Tag = 'TXT_KEY_UNIT_EE_ENGLISH_FIRST_RATE_STRATEGY';

-- Infixo: Howitzer (CBO's Field Gun)
...
INSERT INTO Language_en_US (Tag, Text)
VALUES ('TXT_KEY_UNIT_FIELD_GUN_STRATEGY', 'This is the first siege weapon able to shoot at 3-tile range however must have a LoS.');

INSERT INTO Language_en_US (Tag, Text)
VALUES ('TXT_KEY_UNIT_FIELD_GUN_HELP', 'Howitzer is able to shoot at 3-tile range.');
