...
-- Tavern
UPDATE Language_en_US
SET Text = 'Reduces [ICON_HAPPINESS_3] Boredom slightly. Harbor and Market in City: + 1 [ICON_RESEARCH] Science. Nearby [ICON_RES_WHEAT] Wheat, [ICON_RES_BISON] Bison and [ICON_RES_DEER] Deer: +1 [ICON_FOOD] Food'
