...
UPDATE Buildings SET NumPoliciesNeeded = '10' WHERE Type IN ('BUILDING_GRIPSHOLM', 'BUILDING_EE_VERSAILLES');
...
UPDATE Buildings SET NumPoliciesNeeded = '15' WHERE Type IN ('BUILDING_EE_SMITHSONIAN', 'BUILDING_EE_CRYSTAL_PALACE');
...
UPDATE Building_Flavors SET Flavor = 15 WHERE BuildingType = 'BUILDING_EE_TAVERN' AND FlavorType = 'FLAVOR_HAPPINESS';
