...
UPDATE Technologies SET Cost =    50 WHERE GridX =  1; --60		Ancient: 75 turns
UPDATE Technologies SET Cost =    80 WHERE GridX =  2; --80
UPDATE Technologies SET Cost =   120 WHERE GridX =  3; --125	Classical: 60 turns
UPDATE Technologies SET Cost =   220 WHERE GridX =  4; --225
UPDATE Technologies SET Cost =   330 WHERE GridX =  5; --350	Medieval: 55 turns
UPDATE Technologies SET Cost =   500 WHERE GridX =  6; --550
UPDATE Technologies SET Cost =   800 WHERE GridX =  7; --1000	Renaissance: 55 turns
UPDATE Technologies SET Cost =  1100 WHERE GridX =  8; --1500
...
UPDATE Technologies SET Cost =  3000 WHERE GridX = 11; --2500	Industrial: 45 turns
UPDATE Technologies SET Cost =  4000 WHERE GridX = 12; --3500
UPDATE Technologies SET Cost =  5000 WHERE GridX = 13; --5000	Modern: 45 turns
UPDATE Technologies SET Cost =  6000 WHERE GridX = 14; --6000
UPDATE Technologies SET Cost =  8000 WHERE GridX = 15; --7000	Atomic: 45 turns
UPDATE Technologies SET Cost = 10000 WHERE GridX = 16; --8000
UPDATE Technologies SET Cost = 12000 WHERE GridX = 17; --9000	Information: 60 turns
UPDATE Technologies SET Cost = 14000 WHERE GridX = 18; --10000
UPDATE Technologies SET Cost = 16000 WHERE GridX = 19; --11000
UPDATE Technologies SET Cost = 20000 WHERE GridX = 20; --12000	Future: 20 turns
