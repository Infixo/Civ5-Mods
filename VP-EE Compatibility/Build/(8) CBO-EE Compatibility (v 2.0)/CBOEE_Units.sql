...
UPDATE Unit_Flavors SET Flavor = 30 WHERE UnitType = 'UNIT_EE_SHIP_OF_THE_LINE' AND FlavorType = 'FLAVOR_NAVAL';
UPDATE Unit_Flavors SET Flavor = 20 WHERE UnitType = 'UNIT_EE_SHIP_OF_THE_LINE' AND FlavorType = 'FLAVOR_NAVAL_RECON';
...
UPDATE Units SET Cost = 400, FaithCost =   0 WHERE Type = 'UNIT_ENGLISH_SHIPOFTHELINE'; -- replaces FRIGATE (325p)
UPDATE Units SET Cost = 400, FaithCost =   0 WHERE Type = 'UNIT_EE_SHIP_OF_THE_LINE';
UPDATE Units SET Cost = 400, FaithCost =   0 WHERE Type = 'UNIT_FRIGATE';
UPDATE Units SET Cost = 350, FaithCost =   0 WHERE Type = 'UNIT_PRIVATEER';
