print("Loading Wonders.lua from CBO-EE mod");
-- =================================
-- Crystal Palace
...
-- Author: LeeS
-- ==================================
--[[ Infixo: new code in Compatibility Mod
-- ==================================
...
function VersaillesCompleted(ownerId, cityId, buildingType, bGold, bFaithOrCulture)
	print("VersaillesCompleted() from CBOEE", ownerID, cityID, buildingType, bGold, bFaithOrCulture);
	if buildingType == iVersaillesWonder then
		print("It's Versailles");
...
-- Author: LeeS
-- ==================================
-- Infixo: code disabled, new code for Fasil is in Compatibility Mod
-- ==================================
--[[
...
function UnitsNearFasilGhebbi(playerID, unitID, unitX, unitY)
	print("UnitsNearFasilGhebbi() from CBOEE", playerID, unitID, unitX, unitY);
...
-- Infixo: CTD, reasons unknown
function FasilGhebbiCompleted(ownerId, cityId, buildingType, bGold, bFaithOrCulture)
	print("FasilGhebbiCompleted() from CBOEE", ownerID, cityID, buildingType, bGold, bFaithOrCulture);
	if buildingType == iFasilGhebbiWonder then
		print("It's Fasil");
		iFasilGhebbiOwner = ownerId
		print("iFasilGhebbiOwner is", iFasilGhebbiOwner);
		print("iFasilGhebbiPromotion is", iFasilGhebbiPromotion);
		local pPlayer = Players[ownerId]
		pFasilGhebbiPlot = pPlayer:GetCityByID(cityId):Plot()
		print("Fasil is at (X,Y)=", pFasilGhebbiPlot:GetX(), pFasilGhebbiPlot:GetY());
		for pUnit in pPlayer:Units() do
			print("pUnit:GetDomainType()", pUnit:GetDomainType());
			--if tValidFasilGhebbiUnitDomains[pUnit:GetDomainType()] then
				if pUnit:IsCombatUnit() and (Map.PlotDistance(pUnit:GetX(), pUnit:GetY(), pFasilGhebbiPlot:GetX(), pFasilGhebbiPlot:GetY()) <= iFasilGhebbiRange) then
					pUnit:SetHasPromotion(iFasilGhebbiPromotion, true)
					print("Unit YES");
		...
		print("Subscriptions+UnitsNearFasilGhebbi");
		GameEvents.CityCaptureComplete.Add(FasilGhebbiCityCaptured)
		print("Subscriptions+FasilGhebbiCityCaptured");
		GameEvents.CityConstructed.Remove(FasilGhebbiCompleted)
		print("Subscriptions-FasilGhebbiCompleted");
	end
end
...
function KronborgCompleted(ownerId, cityId, buildingType, bGold, bFaithOrCulture)
	print("KronborgCompleted() from CBOEE", ownerID, cityID, buildingType, bGold, bFaithOrCulture);
...
print("Finished loading Wonders.lua from CBO-EE mod");