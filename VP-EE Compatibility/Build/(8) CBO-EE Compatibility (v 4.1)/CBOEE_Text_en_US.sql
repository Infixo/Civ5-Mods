...
-- Torre del Oro
UPDATE Language_en_US
SET Text = 'Naval trade routes originating from this city have a 50% increase in range, and provide +3 gold for both parties. Grants +1 [ICON_INTERNATIONAL_TRADE] additional Trade Route and a free Harbor.[NEWLINE][NEWLINE]City must be built on the coast.'
