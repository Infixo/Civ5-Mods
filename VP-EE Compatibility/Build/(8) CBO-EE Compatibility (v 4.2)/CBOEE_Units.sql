...
SET PrereqTech = 'TECH_NAVIGATION', ObsoleteTech = 'TECH_DYNAMITE', GoodyHutUpgradeUnitClass = 'UNITCLASS_CRUISER', Civilopedia = 'TXT_KEY_UNIT_EE_ENGLISH_FIRST_RATE_PEDIA',
	Combat = 20, RangedCombat = 28, ShowInPedia = 1,
...
SET GoodyHutUpgradeUnitClass = 'UNITCLASS_FRIGATE', ObsoleteTech = 'TECH_EE_WARSHIPS',
	RangedCombat = 25, Combat = 15, Range = 2, CombatClass = 'UNITCOMBAT_NAVALRANGED', DefaultUnitAI = 'UNITAI_ASSAULT_SEA' 
...
INSERT INTO Unit_FreePromotions (UnitType, PromotionType)
VALUES ('UNIT_EE_GALLEON', 'PROMOTION_ONLY_DEFENSIVE');
...
UPDATE Units
SET ObsoleteTech = 'TECH_INDUSTRIALIZATION', Combat = 35, GoodyHutUpgradeUnitClass = 'UNITCLASS_IRONCLAD'
...
UPDATE Units SET Cost = 350, FaithCost =   0 WHERE Type = 'UNIT_EE_CARRACK'; -- Renaissance, takes place of PRIVATEER
UPDATE Units SET Cost = 375, FaithCost =   0 WHERE Type = 'UNIT_EE_GALLEON'; -- Renaissance, takes place of FRIGATE
...
UPDATE Units SET Cost = 450, FaithCost =   0 WHERE Type = 'UNIT_PRIVATEER'; -- (350p)
UPDATE Units SET Cost = 500, FaithCost =   0 WHERE Type = 'UNIT_FRIGATE'; -- (375p)
UPDATE Units SET Cost = 550, FaithCost =   0 WHERE Type = 'UNIT_ENGLISH_SHIPOFTHELINE'; -- (375p) replaces FRIGATE
UPDATE Units SET Cost = 550, FaithCost =   0 WHERE Type = 'UNIT_EE_SHIP_OF_THE_LINE';
-- Industrial
