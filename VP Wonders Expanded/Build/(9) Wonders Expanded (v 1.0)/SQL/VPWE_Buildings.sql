...
UPDATE Buildings SET Cost =  250, PrereqTech = 'TECH_PHILOSOPHY',   NumPoliciesNeeded = 5, MaxStartEra = 'ERA_MEDIEVAL' WHERE Type = 'BUILDING_SHWEDAGON';
...
('BUILDING_BOROBUDUR', 'BUILDING_HAGIA_SOPHIA', 'BUILDING_NABAWI');
--'BUILDING_KREMLIN',
...
('TXT_KEY_WONDER_MALWIYA_HELP',  'All Stone Works +1 [ICON_PRODUCTION] Production and all Quarries +1 [ICON_PEACE] Faith. Grants a free [COLOR_POSITIVE_TEXT]Great Engineer[ENDCOLOR].[NEWLINE][NEWLINE]City must be built on a [COLOR_CYAN]Hill[ENDCOLOR] and have [COLOR_CYAN]Stone Works[ENDCOLOR] already constructed.'),
