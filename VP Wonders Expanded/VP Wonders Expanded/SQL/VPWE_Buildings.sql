...
UPDATE Buildings
SET NumTradeRouteBonus = 1, MinorFriendshipChange = 50, SpecialistType = 'SPECIALIST_CIVIL_SERVANT', GreatPeopleRateChange = 2
...
('TXT_KEY_WONDER_BROOKLYN_HELP',  'Grants a free [ICON_DIPLOMAT] [COLOR_POSITIVE_TEXT]Great Diplomat[ENDCOLOR], an additional +1 [ICON_INTERNATIONAL_TRADE] Trade Route and an increase of +50% [ICON_INFLUENCE] Influence with all City-States in the world. +33% faster production of Diplomacy Units and generation of [ICON_DIPLOMAT] Great Diplomats in the City.[NEWLINE][NEWLINE]Requires completion of [COLOR_CYAN]Statecraft Branch[ENDCOLOR]. City must be built next to a [COLOR_CYAN]River[ENDCOLOR].'),
...
('TXT_KEY_WONDER_CHARTRES_HELP',  'Grants a free [COLOR_POSITIVE_TEXT]University[ENDCOLOR]. Gain 10% of the [ICON_PEACE] Faith of all cities connected by a Trade Route to this City. Incoming [ICON_INTERNATIONAL_TRADE] Trade Routes generate +1 [ICON_GOLD] Gold for the City, and +3 [ICON_GOLD] Gold for Trade Route owner.[NEWLINE][NEWLINE]Requires completion of [COLOR_CYAN]Tradition Branch[ENDCOLOR].'),
...
('TXT_KEY_WONDER_CHEVALIERS_HELP',  'Grants a free [COLOR_POSITIVE_TEXT]Order[ENDCOLOR]. +33% faster production of Mounted and Siege Units in this City. All Cities that are [COLOR_RED]not[ENDCOLOR] on the Coast receive +1 [ICON_PEACE] Faith, have increased +5 [ICON_STRENGTH] City Defense, +50 HP and provide +1 Military Unit Supply Cap.[NEWLINE][NEWLINE]City must be built on a [COLOR_CYAN]Hill[ENDCOLOR].'),
...
('TXT_KEY_WONDER_MICHEL_HELP',  'Grants a free [COLOR_POSITIVE_TEXT]Monastery[ENDCOLOR]. +1 [ICON_PRODUCTION] Production and [ICON_FOOD] Food from each sea tile worked by the City. +1 [ICON_PEACE] for every 4 [ICON_CITIZEN] population. Increases +10 [ICON_STRENGTH] City Defense and +100 HP. +4 [ICON_TOURISM] Tourism with Flight.[NEWLINE][NEWLINE]City must be built on a [COLOR_CYAN]Single Tile Island[ENDCOLOR].'),
...
('TXT_KEY_WONDER_NAZCA_HELP',  'Nearby Plains receive +1 [ICON_FOOD] Food. All Shrines receive +1 [ICON_PEACE] Faith. +4 [ICON_TOURISM] Tourism with Flight.[NEWLINE][NEWLINE]City must be built on a [COLOR_CYAN]Hill[ENDCOLOR] and on or next to [COLOR_CYAN]Plains[ENDCOLOR].'),
...
('TXT_KEY_WONDER_PANAMA_HELP',  'All Harbors +1 [ICON_GOLD] Gold and all Seaports +2 [ICON_GOLD] Gold. Grants a free [ICON_GREAT_MERCHANT] [COLOR_POSITIVE_TEXT]Great Merchant[ENDCOLOR] and an additional +1 [ICON_INTERNATIONAL_TRADE] Trade Route. Sea Trade Routes originating from this City have a 50% increase in range and provide +3 [ICON_GOLD] Gold for the city owner. +33% faster generation of [ICON_GREAT_MERCHANT] Great Merchants in the City.[NEWLINE][NEWLINE]City must be built on the [COLOR_CYAN]Coast[ENDCOLOR] and on a [COLOR_CYAN]Flat[ENDCOLOR] terrain.'),
...
INSERT INTO GreatWorks (Type, Description, GreatWorkClassType, Audio, Image) VALUES
--('GREAT_WORK_ARK_COVENANT', 'TXT_KEY_GREAT_WORK_ARK_COVENANT', 'GREAT_WORK_ARTIFACT', 'ERA_CLASSICAL', 'VPWE_GW_Ark_Covenant.dds');
('GREAT_WORK_ARK_COVENANT', 'TXT_KEY_GREAT_WORK_ARK_COVENANT', 'GREAT_WORK_ART', 'AS2D_GREAT_ARTIST_ARTWORK', 'VPWE_GW_Ark_Covenant.dds');

INSERT INTO Building_Flavors (BuildingType, FlavorType, Flavor) VALUES
('BUILDING_SOLOMON', 'FLAVOR_CULTURE', 40),
('BUILDING_SOLOMON', 'FLAVOR_RELIGION', 30);
