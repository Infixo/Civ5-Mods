...
UPDATE Buildings SET Cost = 1600, PrereqTech = 'TECH_STEAM_POWER',  NumPoliciesNeeded = 17                             WHERE Type = 'BUILDING_TRAFALGAR'; -- exception for FREEDOM!
...
('BUILDING_WHITESANDS', 'RESOURCE_OIL', 2);
...
UPDATE Buildings
SET FreePolicies = 1, SpecialistType = 'SPECIALIST_CIVIL_SERVANT', GreatPeopleRateChange = 2
...
('TXT_KEY_WONDER_ANITKABIR_HELP',  '1 Free [COLOR_POSITIVE_TEXT]Social Policy[ENDCOLOR]. Grants +2 [ICON_RES_PAPER] Paper. +25% faster production of Diplomacy Units and generation of [ICON_DIPLOMAT] Great Diplomats in the City.[NEWLINE][NEWLINE]Requires [COLOR_CYAN]Autocracy[ENDCOLOR]. City must be built on a [COLOR_CYAN]Flat[ENDCOLOR] terrain.'),
...
UPDATE Buildings
SET NumTradeRouteBonus = 1, MinorFriendshipChange = 25, SpecialistType = 'SPECIALIST_ENGINEER', GreatPeopleRateChange = 1
...
VALUES ('BUILDING_BROOKLYN', 'UNITCOMBAT_DIPLOMACY', 25);
...
('TXT_KEY_WONDER_BROOKLYN_HELP',  'Receive a free Great Diplomat, an additional +1 [ICON_INTERNATIONAL_TRADE] Trade Route and an increase of +25% [ICON_INFLUENCE] Influence with all City-States in the world. +25% faster production of Diplomacy Units in the City.[NEWLINE][NEWLINE]Requires completion of [COLOR_CYAN]Statecraft Branch[ENDCOLOR]. City must be built next to a [COLOR_CYAN]River[ENDCOLOR].'),
...
UPDATE Buildings
SET FreeBuildingThisCity = 'BUILDINGCLASS_SYNAGOGUE', TradeRouteRecipientBonus = 1, TradeRouteTargetBonus = 3, SpecialistType = 'SPECIALIST_ENGINEER', GreatPeopleRateChange = 1
...
('TXT_KEY_WONDER_CHARTRES_HELP',  'Gain 10% of the [ICON_PEACE] Faith of all cities sending a Trade Route to this City. Incoming [ICON_INTERNATIONAL_TRADE] Trade Routes generate +1 [ICON_GOLD] Gold for the City, and +3 [ICON_GOLD] Gold for Trade Route owner. Provides a free [COLOR_POSITIVE_TEXT]Synagogue[ENDCOLOR].[NEWLINE][NEWLINE]Requires completion of [COLOR_CYAN]Tradition Branch[ENDCOLOR].'),
...
UPDATE Buildings
SET ExtraCityHitPoints = 0, Defense = 0, FreeBuildingThisCity = 'BUILDINGCLASS_CASTLE'
...
INSERT INTO Building_UnitCombatProductionModifiers 	(BuildingType, UnitCombatType, Modifier) VALUES
('BUILDING_CHEVALIERS', 'UNITCOMBAT_MOUNTED', 50);
...
('BUILDING_CHEVALIERS', 'FLAVOR_GREAT_PEOPLE', 20),
('BUILDING_CHEVALIERS', 'FLAVOR_OFFENSE', 30);

INSERT INTO Language_en_US (Tag, Text)VALUES
('TXT_KEY_BUILDING_CHEVALIERS',     'Krak des Chevaliers'),
('TXT_KEY_WONDER_CHEVALIERS_HELP',  'Grants a free [COLOR_POSITIVE_TEXT]Great General[ENDCOLOR]. In the City where it is built provides a free [COLOR_POSITIVE_TEXT]Castle[ENDCOLOR] and +50% faster production of Mounted Units. All Cities that are [COLOR_RED]not[ENDCOLOR] on the Coast have increased +5 [ICON_STRENGTH] City Defense, +50 HP and provide +1 Military Unit Supply Cap.[NEWLINE][NEWLINE]City must be built on a [COLOR_CYAN]Hill[ENDCOLOR].'),
...
-- All Guilds +2 of the respective GP point and +25% inc rate of the respective GP. Also +5 Gold from each Guild.
-- Haha, not possible...
-- Alternative: GlobalGreatPeopleRateModifier +10%, Reduces Boredom, All Guilds: +5 Gold and +5 Cul
----------------------------------------------------
...
INSERT INTO Building_SpecificGreatPersonRateModifier (BuildingType, SpecialistType, Modifier) VALUES
('BUILDING_HOLLYWOOD', 'SPECIALIST_WRITER', 25),
('BUILDING_HOLLYWOOD', 'SPECIALIST_MUSICIAN', 25),
('BUILDING_HOLLYWOOD', 'SPECIALIST_ARTIST', 25);
...
('TXT_KEY_WONDER_HOLLYWOOD_HELP',  '1 Free [COLOR_POSITIVE_TEXT]Social Policy[ENDCOLOR]. Reduces [ICON_HAPPINESS_3] Boredom in all cities. +25% faster generation of [ICON_GREAT_WRITER] Great Writers, [ICON_GREAT_ARTIST] Artists and [ICON_GREAT_MUSICIAN] Musicians in the City. +5 [ICON_GOLD] Gold and +5 [ICON_CULTURE] Culture from all Guilds.[NEWLINE][NEWLINE]Requires [COLOR_CYAN]Freedom[ENDCOLOR]. City must be built on a [COLOR_CYAN]Hill[ENDCOLOR].'),
...
-- Free Medical, +2 Hap from Train Stations
...
('BUILDING_JUMEIRAH', 'YIELD_CULTURE', 10),
('BUILDING_JUMEIRAH', 'YIELD_FOOD', 10);

INSERT INTO Building_BuildingClassYieldChanges (BuildingType, BuildingClassType, YieldType, YieldChange) VALUES
('BUILDING_JUMEIRAH', 'BUILDINGCLASS_TRAINSTATION', 'YIELD_CULTURE', 5);
...
INSERT INTO Building_Flavors (BuildingType, FlavorType, Flavor) VALUES
('BUILDING_JUMEIRAH', 'FLAVOR_CULTURE', 40),
('BUILDING_JUMEIRAH', 'FLAVOR_GOLD', 20),
('BUILDING_JUMEIRAH', 'FLAVOR_GROWTH', 40),
('BUILDING_JUMEIRAH', 'FLAVOR_HAPPINESS', 40);

INSERT INTO Language_en_US (Tag, Text) VALUES
('TXT_KEY_BUILDING_JUMEIRAH',     'Palm Jumeirah'),
('TXT_KEY_WONDER_JUMEIRAH_HELP',  'All Train Stations +5 [ICON_CULTURE] Culture and +2 [ICON_HAPPINESS_1] Happiness. In the City +10% [ICON_FOOD] Food and [ICON_CULTURE] Culture, and each worked Atoll or Oasis +10 [ICON_GOLD] Gold.[NEWLINE][NEWLINE]City must be built on the [COLOR_CYAN]Coast[ENDCOLOR] and have an [COLOR_CYAN]Atoll[ENDCOLOR] or an [COLOR_CYAN]Oasis[ENDCOLOR] nearby.'),
...
UPDATE Buildings
SET MinorityHappinessChangeGlobal = -10, FreeBuildingThisCity = 'BUILDINGCLASS_TEMPLE', EnhancedYieldTech = 'TECH_FLIGHT', TechEnhancedTourism = 4,
...
INSERT INTO Building_FeatureYieldChanges (BuildingType, FeatureType, YieldType, Yield) VALUES
('BUILDING_KARNAK', 'FEATURE_FLOOD_PLAINS', 'YIELD_FAITH', 2),
...
('TXT_KEY_WONDER_KARNAK_HELP',  'Reduces slightly [ICON_HAPPINESS_3] Religious Unrest in all cities. Free [COLOR_POSITIVE_TEXT]Temple[ENDCOLOR] in this city. +2 [ICON_PEACE] Faith and +1 [ICON_PRODUCTION] Production from Flood Plains worked by the city. +4 [ICON_TOURISM] Tourism with Flight.[NEWLINE][NEWLINE]City must have [COLOR_CYAN]Flood Plains[ENDCOLOR] or an [COLOR_CYAN]Oasis[ENDCOLOR] nearby.'),
...
UPDATE Buildings
SET DefenseHappinessChangeGlobal = -10, MinorityHappinessChangeGlobal = -10, SpecialistType = 'SPECIALIST_MERCHANT', GreatPeopleRateChange = 1
WHERE Type = 'BUILDING_KINKAKUJI';

INSERT INTO Building_YieldChanges (BuildingType, YieldType, Yield)
VALUES ('BUILDING_KINKAKUJI', 'YIELD_FAITH', 3);
...
VALUES
	('BUILDING_KINKAKUJI', 'FLAVOR_CULTURE', 15),
	('BUILDING_KINKAKUJI', 'FLAVOR_HAPPINESS', 25),
	('BUILDING_KINKAKUJI', 'FLAVOR_RELIGION', 20);

INSERT INTO Language_en_US (Tag, Text)
VALUES
('TXT_KEY_BUILDING_KINKAKUJI',     'Kinkaku-ji (The Golden Pavilion)'),
('TXT_KEY_WONDER_KINKAKUJI_HELP',  'Reduces slightly [ICON_HAPPINESS_3] Crime and [ICON_HAPPINESS_3] Religious Unrest in all cities. +1 [ICON_PEACE] Faith and +1 [ICON_CULTURE] Culture from each Lake tile worked by the city.[NEWLINE][NEWLINE]City must be built near the [COLOR_CYAN]Lake[ENDCOLOR].'),
...
('BUILDING_MALWIYA', 'FLAVOR_PRODUCTION', 30),
('BUILDING_MALWIYA', 'FLAVOR_RELIGION', 50);

INSERT INTO Language_en_US (Tag, Text)
VALUES
('TXT_KEY_BUILDING_MALWIYA',     'Malwiya Minaret'),
--('TXT_KEY_WONDER_MALWIYA_HELP',  'Grants a free [COLOR_POSITIVE_TEXT]Great Engineer[ENDCOLOR]. All Stone Works +1 [ICON_PEACE] Faith. Enhances resources worked by this city: [ICON_RES_STONE][ICON_RES_MARBLE][ICON_RES_JADE][ICON_RES_LAPIS]: +1 [ICON_PRODUCTION] and +1 [ICON_PEACE].[NEWLINE][NEWLINE]City must be built on a [COLOR_CYAN]Hill[ENDCOLOR] and have [COLOR_CYAN]Stone Works[ENDCOLOR] already constructed.'),
('TXT_KEY_WONDER_MALWIYA_HELP',  'All Stone Works +1 [ICON_PRODUCTION] Production and all Quarries +1 [ICON_PEACE] Faith. Grants a free [COLOR_POSITIVE_TEXT]Great Engineer[ENDCOLOR].[NEWLINE][NEWLINE]City must have [COLOR_CYAN]Stone Works[ENDCOLOR] already constructed.'),
...
UPDATE Buildings
SET FreeBuildingThisCity = 'BUILDINGCLASS_CHURCH', ExtraCityHitPoints = 100, Defense = 1000, EnhancedYieldTech = 'TECH_FLIGHT', TechEnhancedTourism = 4
...
-- Free Hotel and Jewelery, +15% GP rate in all cities, +1T&2G from all Hotels
----------------------------------------------------

UPDATE Buildings
SET FreeBuildingThisCity = 'BUILDINGCLASS_HOTEL', GlobalGreatPeopleRateModifier = 15, NumTradeRouteBonus = 1
WHERE Type = 'BUILDING_MONTECARLO';

INSERT INTO Building_YieldChanges (BuildingType, YieldType, Yield) VALUES
('BUILDING_MONTECARLO', 'YIELD_GOLD', 5);
...
('BUILDING_MONTECARLO', 'FLAVOR_GREAT_PEOPLE', 40),
('BUILDING_MONTECARLO', 'FLAVOR_HAPPINESS', 10);

INSERT INTO Language_en_US (Tag, Text) VALUES
('TXT_KEY_BUILDING_MONTECARLO',     'Monte Carlo Casino'),
('TXT_KEY_WONDER_MONTECARLO_HELP',  'Grants a free [COLOR_POSITIVE_TEXT]Hotel[ENDCOLOR], +1 [ICON_RES_JEWELRY] [COLOR_POSITIVE_TEXT]Jewelery[ENDCOLOR] and an additional +1 [ICON_INTERNATIONAL_TRADE] [COLOR_POSITIVE_TEXT]Trade Route[ENDCOLOR]. All Hotels generate +1 [ICON_TOURISM] Tourism and +2 [ICON_GOLD] Gold. +15% faster generation of all [ICON_GREAT_PEOPLE] Great People in all Cities.[NEWLINE][NEWLINE]Requires completion of [COLOR_CYAN]Artistry Branch[ENDCOLOR]. City must be built on the [COLOR_CYAN]Coast[ENDCOLOR].'),
...
-- Gives a free Order. Building_GlobalYieldModifiers +10% Faith. 1 slot of GWW
----------------------------------------------------

UPDATE Buildings
SET FreeBuildingThisCity = 'BUILDINGCLASS_ORDER', GreatWorkSlotType = 'GREAT_WORK_SLOT_LITERATURE', GreatWorkCount = 1, SpecialistType = 'SPECIALIST_WRITER', GreatPeopleRateChange = 2
...
('TXT_KEY_WONDER_NABAWI_HELP',  'Grants a free [COLOR_POSITIVE_TEXT]Order[ENDCOLOR]. All Cities generate +10% [ICON_PEACE] Faith. Has 1 slot for a [ICON_GREAT_WORK] Great Work of Writing. [NEWLINE][NEWLINE]Must be built in a [COLOR_CYAN]Holy City[ENDCOLOR].'),
...
----------------------------------------------------
-- NAZCA - Nazca Lines
-- +1 Faith from Shrines, Tourism with Flight, +1 Food from Plains, +2 Sci in city
----------------------------------------------------
...
INSERT INTO Building_YieldChanges (BuildingType, YieldType, Yield) VALUES
('BUILDING_NAZCA', 'YIELD_FOOD', 2),
('BUILDING_NAZCA', 'YIELD_SCIENCE', 2);
...
('TXT_KEY_WONDER_NAZCA_HELP',  'Nearby Plains receive +2 [ICON_FOOD] Food. +1 [ICON_PEACE] Faith from all Shrines. +4 [ICON_TOURISM] Tourism with Flight.[NEWLINE][NEWLINE]City must be built on a [COLOR_CYAN]Hill[ENDCOLOR] and on or next to [COLOR_CYAN]Plains[ENDCOLOR].'),
...
('TXT_KEY_WONDER_PANAMA_HELP',  'All Harbors +1 [ICON_GOLD] Gold and all Seaports +2 [ICON_GOLD] Gold. Grants an additional +1 [ICON_INTERNATIONAL_TRADE] Trade Route. Sea Trade Routes originating from this City have a 50% increase in range and provide +3 [ICON_GOLD] Gold for the city owner.[NEWLINE][NEWLINE]City must be built on the [COLOR_CYAN]Coast[ENDCOLOR] and on a [COLOR_CYAN]Flat[ENDCOLOR] terrain.'),
...
UPDATE Buildings
SET FreeBuildingThisCity = 'BUILDINGCLASS_ARTISTS_GUILD', GreatWorkSlotType = 'GREAT_WORK_SLOT_ART_ARTIFACT', GreatWorkCount = 4, ThemingBonusHelp = 'TXT_KEY_SHWEDAGON_THEMING_BONUS_HELP',
...
INSERT INTO Building_SpecificGreatPersonRateModifier (BuildingType, SpecialistType, Modifier) VALUES
('BUILDING_SHWEDAGON', 'SPECIALIST_ARTIST', 25);
...
('BUILDING_SHWEDAGON', 'TXT_KEY_THEMING_BONUS_SHWEDAGON', 16, 1, 1, 5);

INSERT INTO Building_ThemingYieldBonus (BuildingType, YieldType, Yield) VALUES
('BUILDING_SHWEDAGON', 'YIELD_CULTURE', 4),
('BUILDING_SHWEDAGON', 'YIELD_FAITH', 4),
('BUILDING_SHWEDAGON', 'YIELD_GOLDEN_AGE_POINTS', 4),
('BUILDING_SHWEDAGON', 'YIELD_TOURISM', 4);

INSERT INTO Building_Flavors (BuildingType, FlavorType, Flavor) VALUES
('BUILDING_SHWEDAGON', 'FLAVOR_CULTURE', 50),
('BUILDING_SHWEDAGON', 'FLAVOR_GREAT_PEOPLE', 40),
('BUILDING_SHWEDAGON', 'FLAVOR_RELIGION', 30);

INSERT INTO Language_en_US (Tag, Text) VALUES
('TXT_KEY_BUILDING_SHWEDAGON',     'Shwedagon Paya'),
('TXT_KEY_WONDER_SHWEDAGON_HELP',  'Grants a free [COLOR_POSITIVE_TEXT]Artists'' Guild[ENDCOLOR]. In the City +2 [ICON_PEACE] Faith from Artists and [ICON_GREAT_ARTIST] Great Artists are generated +25% faster. Has 4 slots for [ICON_GREAT_WORK] Great Works of Art. Provides +4 [ICON_CULTURE] Culture, [ICON_PEACE] Faith, [ICON_GOLDEN_AGE] Golden Age Points and [ICON_TOURISM] Tourism if Themed.[NEWLINE]  Requires an improved [ICON_RES_GOLD] [COLOR_CYAN]Gold[ENDCOLOR], [ICON_RES_SILVER] [COLOR_CYAN]Silver[ENDCOLOR], [ICON_RES_GEMS] [COLOR_CYAN]Gems[ENDCOLOR] or [ICON_RES_PEARLS] [COLOR_CYAN]Pearls[ENDCOLOR] nearby.'),
...
-- Gives a free Synagogue. Ark of Covenant.
----------------------------------------------------

UPDATE Buildings
SET FreeBuildingThisCity = 'BUILDINGCLASS_SYNAGOGUE', GreatWorkSlotType = 'GREAT_WORK_SLOT_ART_ARTIFACT', GreatWorkCount = 1, ReligiousPressureModifier = 100
...
('TXT_KEY_WONDER_SOLOMON_HELP',  'Grants a free [COLOR_POSITIVE_TEXT]Synagogue[ENDCOLOR]. Doubles religious pressure from the City. Has 1 slot for a [ICON_GREAT_WORK] Great Work of Art or Artifact which contains the [COLOR_POSITIVE_TEXT]Ark of Covenant[ENDCOLOR].[NEWLINE][NEWLINE]Must be built in a [COLOR_CYAN]Holy City[ENDCOLOR].'),
...
-- Sputnik Program: Reduces Boredom. SS parts build +25% faster. Faster +25% GEs&GSs in the city. Faster GPs in all Cities.  Increases Influence with all City States by +40
----------------------------------------------------

UPDATE Buildings
SET FreePolicies = 1, UnculturedHappinessChangeGlobal = -20, SpaceProductionModifier = 25, GlobalGreatPeopleRateModifier = 10, SpecialistType = 'SPECIALIST_ENGINEER', GreatPeopleRateChange = 2, MinorFriendshipChange = 25
WHERE Type = 'BUILDING_SPUTNIK';

INSERT INTO Building_SpecificGreatPersonRateModifier (BuildingType, SpecialistType, Modifier) VALUES
('BUILDING_SPUTNIK', 'SPECIALIST_ENGINEER', 25),
('BUILDING_SPUTNIK', 'SPECIALIST_SCIENTIST', 25);

INSERT INTO Building_Flavors (BuildingType, FlavorType, Flavor) VALUES
('BUILDING_SPUTNIK', 'FLAVOR_DIPLOMACY', 10),
('BUILDING_SPUTNIK', 'FLAVOR_GREAT_PEOPLE', 40),
('BUILDING_SPUTNIK', 'FLAVOR_HAPPINESS', 30),
('BUILDING_SPUTNIK', 'FLAVOR_SCIENCE', 30),
('BUILDING_SPUTNIK', 'FLAVOR_SPACESHIP', 40);

INSERT INTO Language_en_US (Tag, Text) VALUES
('TXT_KEY_BUILDING_SPUTNIK',     'The Sputnik Program'),
('TXT_KEY_WONDER_SPUTNIK_HELP',  '1 Free [COLOR_POSITIVE_TEXT]Social Policy[ENDCOLOR]. Reduces [ICON_HAPPINESS_3] Boredom in all cities. +25% faster generation of [ICON_GREAT_ENGINEER] Great Engineers and [ICON_GREAT_SCIENTIST] Scientists in this City and +10% faster generation of all [ICON_GREAT_PEOPLE] Great People in all Cities. +25% [ICON_PRODUCTION] Production in this City when building Spaceship Parts. Receive an increase of +25% [ICON_INFLUENCE] Influence with all City-States in the world.[NEWLINE]  Requires [COLOR_CYAN]Order[ENDCOLOR]. City must be built on a [COLOR_CYAN]Flat[ENDCOLOR] terrain.'),
...
-- Starts GA. all Banks +1G and StockExch +2G; Tourism & GAP from Allies & half from Friends
----------------------------------------------------
...
INSERT INTO Building_BuildingClassYieldChanges (BuildingType, BuildingClassType, YieldType, YieldChange) VALUES
('BUILDING_TAIPEI101', 'BUILDINGCLASS_BANK',		   'YIELD_GOLD', 1),
...
('TXT_KEY_WONDER_TAIPEI101_HELP',  'A [ICON_GOLDEN_AGE] [COLOR_POSITIVE_TEXT]Golden Age[ENDCOLOR] begins. All Banks +1 [ICON_GOLD] Gold and all Stock Exchanges +2 [ICON_GOLD] Gold. The City receives +4 [ICON_TOURISM] Tourism and +2 [ICON_GOLDEN_AGE] Golden Age Points from each Allied City-State and half of that from each Friendly one.[NEWLINE][NEWLINE]City must be built on a [COLOR_CYAN]Flat[ENDCOLOR] terrain and have a [COLOR_CYAN]Jungle[ENDCOLOR] or [COLOR_CYAN]Forest[ENDCOLOR] neraby.'),
...
-- Trafalgar Square: Extend range of all TRs. All Cities CS +20%. Free Mine Field in the City.
----------------------------------------------------

UPDATE Buildings
SET FreePolicies = 1, FreeBuildingThisCity = 'BUILDINGCLASS_MINEFIELD', NumTradeRouteBonus = 1, TradeRouteLandDistanceModifier = 50, TradeRouteSeaDistanceModifier = 50,
	SpecialistType = 'SPECIALIST_CIVIL_SERVANT', GreatPeopleRateChange = 2, MinorFriendshipChange = 50
...
('BUILDING_TRAFALGAR', 'FLAVOR_RELIGION', 30),
('BUILDING_TRAFALGAR', 'FLAVOR_SCIENCE', 20);

INSERT INTO Language_en_US (Tag, Text)
VALUES
('TXT_KEY_BUILDING_TRAFALGAR',     'Trafalgar Square'),
('TXT_KEY_WONDER_TRAFALGAR_HELP',  '1 Free [COLOR_POSITIVE_TEXT]Social Policy[ENDCOLOR]. Receive an increase of +50% [ICON_INFLUENCE] Influence with all City-States in the world and an additional +1 [ICON_INTERNATIONAL_TRADE] Trade Route. Trade Routes originating from this city have a 50% increase in range and the City receives a free [COLOR_POSITIVE_TEXT]Mine Field[ENDCOLOR].[NEWLINE][NEWLINE]Requires [COLOR_CYAN]Freedom[ENDCOLOR]. City must be built next to a [COLOR_CYAN]River[ENDCOLOR].'),
...
INSERT INTO Building_UnitCombatProductionModifiers 	(BuildingType, UnitCombatType, Modifier) VALUES
('BUILDING_WHITESANDS', 'UNITCOMBAT_MISSILE', 25);
...
('PROMOTION_WHITESANDS', 'TXT_KEY_PROMOTION_WHITESANDS', 'TXT_KEY_PROMOTION_WHITESANDS_HELP', 'AS2D_IF_LEVELUP', 1, 2, 34, 'PROMOTION_ATLAS', 'PEDIA_SHARED', 'TXT_KEY_PROMOTION_WHITESANDS');
...
('TXT_KEY_WONDER_WHITESANDS_HELP',  'Grants 2 free [COLOR_POSITIVE_TEXT]Guided Missiles[ENDCOLOR]. +25% [ICON_PRODUCTION] Production in this City when building Missiles and Spaceship Parts. Missile units get [COLOR_POSITIVE_TEXT]White Sands Tested[ENDCOLOR] promotion which extends +2 [ICON_RANGE_STRENGTH] Operational Range.[NEWLINE][NEWLINE]Requires completion of [COLOR_CYAN]Imperialism Branch[ENDCOLOR]. City must be built on or next to a [COLOR_CYAN]Desert[ENDCOLOR]. 2 [ICON_RES_OIL] [COLOR_CYAN]Oil[ENDCOLOR] are used to build the Missile Range.'),
